...
namespace TestowyKolos2.Migrations
{
    ...
    [Migration("20230613221140_FixMigration")]
            ...
            modelBuilder.Entity("TestowyKolos2.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            AcceptedAt = new DateTime(2023, 6, 13, 22, 11, 39, 787, DateTimeKind.Utc).AddTicks(9967),
                            ClientID = 1,
                            EmployeeID = 1
                        });
                });
            ...
            modelBuilder.Entity("TestowyKolos2.Models.Order", b =>
                {
                    ...
                    b.HasOne("TestowyKolos2.Models.Employee", "Employee")
                        .WithMany("Orders")
